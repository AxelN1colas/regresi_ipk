...
st.markdown("<h1 style='text-align: center; color: #4CAF50;'>Prediksi IPK - 1677<?h1>", unsafe_allow_html=True)
...
if uploaded_file is not None:
    ...
    st.write("<h3 style='text-align: center; color #007e36;'>Data yang diupload:</h3>", unsafe_allow_html=True)
    st.dataframe(input_data)

    model_directory = r'C:\Tugas3_A_11677'
